...
//        }
    ...
    protected void initToolbarNav(Toolbar toolbar, String name) {
...
//        toolbar.setTitle(name);
    ...
    protected void initToolbarNav(Toolbar toolbar, String name, int icon, View.OnClickListener listener) {
        TextView title = (TextView) toolbar.findViewById(R.id.toolbar_title);
        title.setText(name);
        toolbar.setNavigationIcon(R.mipmap.ic_arrow_back_white_24dp);
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
        ...
        ImageView right = (ImageView) toolbar.findViewById(R.id.toolbar_right);
        right.setVisibility(View.VISIBLE);
        right.setBackgroundResource(icon);
        right.setOnClickListener(listener);
    }

    protected void initToolbarName(Toolbar toolbar, String name) {
        TextView title = (TextView) toolbar.findViewById(R.id.toolbar_title);
        title.setText(name);
    }
}
